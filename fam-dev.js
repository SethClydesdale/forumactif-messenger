        ...
        changeColor : function (color) {
          ...
          $('body').append(
            '<style id="FAM-color-stylesheet" type="text/css">'+
              ...
              '#FAM a, #FAM-new-topic .fa-circle, .FAM-chat-icon.FAM-new-post .fa-circle, #FAM-tab-add:hover, #FAM-version-status-icon .fa-check-circle { color:' + palette[0] + '; }'+
              ...
              '#FAM .FAM-inputbox:focus { border-color:' + palette[0] + '; }'+
