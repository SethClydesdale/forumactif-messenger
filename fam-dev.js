    ...
    page : {
      ...
      about : {
        open : function (noHistory) {
          ...
          FAM.request = $.get(FAM.page.dir + 'about.html', function (data) {
          ...
          if (!FAM.page.login.submitting) {
            ...
            FAM.request = $.post('/login', $(document.fam_form_login).serialize() + '&login=1', function (data) {
              ...
              if (/_userdata\["session_logged_in"\] = 1/.test(data)) {
                ...
                if (FAM.config.show_menu_avatar) {
        ...
        logout : function () {
          if (!FAM.page.profile.logging_out && confirm(FAM.config.lang.profile_confirm_sign_out)) {
            ...
            FAM.request = $.get('/login?logout=true&change_version=prosilver', function (data) {
              ...
              if (form) {
                FAM.request = $.get(form.action + '&key=' + form.key.value, function () {
        ...
        '<div id="FAM-toolbar">'+
          '<div id="FAM-toolbar-inner">'+
            ...
            '<div id="FAM-menu" style="visibility:hidden;">'+
              ...
              '<div id="FAM-menu-profile" class="FAM-menu-option" onclick="FAM.page.profile.open();" title="' + FAM.config.lang.tooltip_profile + '"' + ( !_userdata.session_logged_in ? ' style="display:none"' : '' ) + '>' + ( FAM.config.show_menu_avatar ? '<span id="FAM-menu-avatar">' + _userdata.avatar + '</span>' : '<i class="fa fa-user"></i>' ) + '</div>'+
